  ...
  return (
    <article className={`${styles.article} ${theme === 'dark' ? styles.dark : ''}`}>
      <div className={styles.article_container}>
        ...
        <img className={styles.author_profile_logo}src="/img/ава_конь_тёмный_фон.svg"alt="Author Avatar"/>
          <span className={styles.nickname}>author nickname</span>
          <span className={styles.pub_date}>11.09.2001</span>
        </div>
        
        <img src="/img/image 1.png"alt="Chess Image"className={styles.article_preview}/>
        ...
        <div className={styles.reactions}>
          ...
          <img className={styles.icon_view}src="/img/глаза.svg" alt="Icon 1"/>
            999
          </span>
